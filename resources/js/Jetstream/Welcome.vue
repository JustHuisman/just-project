    ...
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            <div class="mt-6 text-gray-500">
                Dit is een simpel test project wat gegenereerd is door middel van Laravel Jetstream.
                Het gaat er hier puur om dat wij kunnen zien hoe jij je weg kan vindt binnen een bestaand project.
            </div>
